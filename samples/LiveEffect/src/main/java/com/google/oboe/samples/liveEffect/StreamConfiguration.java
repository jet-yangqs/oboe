...
public class StreamConfiguration {
    ...
    private int mRecordDeviceId;
    private int mPlayDeviceId;
    ...
    public void reset() {
        mNativeApi = NATIVE_API_AAUDIO;
        mSampleRate = 16000;
        mChannelCount = 1;
        mFormat = AUDIO_FORMAT_PCM_16;
        mSharingMode = SHARING_MODE_SHARED;
        mPerformanceMode = PERFORMANCE_MODE_LOW_LATENCY;
        mInputPreset = INPUT_PRESET_VOICE_COMMUNICATION;
        mUsage = USAGE_VOICE_COMMUNICATION; // FIXME add USAGE_*
        mRecordDeviceId = UNSPECIFIED;
        mPlayDeviceId = UNSPECIFIED;
        mSessionId = -1;
        mFormatConversionAllowed = true;
        mChannelConversionAllowed = true;
        mRateConversionQuality = RATE_CONVERSION_QUALITY_MEDIUM;
    ...
    public int getRecordDeviceId() {
        return mRecordDeviceId;
    }
    public int getPlayDeviceId() {
        return mPlayDeviceId;
    }

    public void setDeviceId(int deviceId) {
        this.mDeviceId = deviceId;
    }
    public void setRecordDeviceId(int deviceId) {
        this.mRecordDeviceId = deviceId;
    }
    public void setPlayDeviceId(int deviceId) {
        this.mPlayDeviceId = deviceId;
    }

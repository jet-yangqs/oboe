...
public class OboeJavaAudioEngine {

    final static String TAG = "OboeJavaAudioEngine.java: ";
    // Load native library
    static {
    ...
    // config parameters
    public StreamConfiguration mConfig;
...
//    static native boolean isMMapSupported();
    ...
    static native boolean isAAudioRecommended();
    static native boolean createNativeAudioEngine();
    static native int setupNativeAudioEngineParameters(int peroidLenInMilliSeconds,
                                           ByteBuffer record_bb,
                                           ByteBuffer play_bb,
                                           int nativeApi,
                                           int sampleRate,
                                           int channelCount,
    ...
    static native int startNativeAudio();
    static native int stopNativeAudio();
    static native int releaseNativeAudioEngine();
